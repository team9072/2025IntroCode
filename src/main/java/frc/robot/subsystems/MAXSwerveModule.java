...
public class MAXSwerveModule {
  ...
  private final SparkMax m_tuningSparkMax;
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    m_tuningSparkMax = new SparkMax(turningCANId, MotorType.kBrushless);

    m_drivingEncoder = m_drivingSparkMax.getEncoder();
    m_turningEncoder = m_tuningSparkMax.getAbsoluteEncoder();

    m_drivingClosedLoopController = m_drivingSparkMax.getClosedLoopController();
    m_turningClosedLoopController = m_tuningSparkMax.getClosedLoopController();
    ...
    m_tuningSparkMax.configure(Configs.MAXSwerveModule.turningConfig, ResetMode.kResetSafeParameters,
        PersistMode.kPersistParameters);
